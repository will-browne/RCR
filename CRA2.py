...
class CRA2:
    def __init__(self,population,Problem_Id,Problem_length,System_Id,Is_ten_Folder=None):
        ...
        self.final_acc, self.final_size,self.final_set =self.CRA2_Implement(self.population)
    ...
    def CRA2_Implement(self,population):
        print('==================================')
        print('CRA2')
        ...
        for i in range(0,len(self.env.state)):
            ...
            for c_id in C_Set:
                ...
                if self.system_Id==0:
                    score=population[c_id][4]*population[c_id][2]
                #3 Accuracy 2 Numerosity XCS
                elif self.system_Id==1:
                    score=population[c_id][3]*population[c_id][2]
                if score>best_score:
                    best_score=score
                    best_Id=c_id
