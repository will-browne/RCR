...
class Fu1:
    def __init__(self,population,Problem_Id,Problem_length,System_Id,Is_ten_Folder=None):
        ...
        self.final_acc, self.final_size,self.final_set =self.Fu1_Implement(self.population)
    ...
    #This approach completely follows Fu's first approach.
    def Fu1_Implement(self,population):
        print('==================================')
